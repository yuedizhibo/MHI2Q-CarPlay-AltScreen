...
[ -s "$MIRROR_RELEASE/watermark.rgba" ] || { echo "FAIL: dynamic text watermark asset missing"; exit 1; }
...
[ -s "$MIRROR_RUNTIME/watermark.rgba" ] || fail "dynamic text watermark asset was not staged"
